...
{
    public class CellSolver2FullAP_SomaImplicit : NDSimulation
    {
        ...
        public const double ni = 0.25, mi = 0.2, hi = 0.1;       //state probabilities
        ...
        public override void Set1DValues(Tuple<int, double>[] newValues)
        {
            ...
            {
                int j = newVal.Item1;
                Debug.Log("raycast = " + newVal.Item2);
        ...
        protected override void Solve()
        {
            ...
            k = endTime / ((double)nT * 0.3); //Time step size min is 0.27
            ...
            //Matrix lhsM = Matrix.Build.Dense(myCell.vertCount, myCell.vertCount);
            ...
            rhsMarray[NeuronCell.vertCount - 1, NeuronCell.vertCount - 1] = 1;
            lhsMarray[NeuronCell.vertCount - 1, NeuronCell.vertCount - 1] = 1;

            //for (int p = 1; p < myCell.vertCount - 1; p++)
            for (int p = 0; p < NeuronCell.vertCount - 1; p++)
            {
