...
{
    public class sparse_cholesky_test : NDSimulation
    {
        ...
        public bool use_Ck = false;                       // if you choose to compute k = Ck *h
        public double Ck = 1;                             // Multiplier for choosing k, i.e, k = Ck *h 
        public bool HK_auto = true;                       // auto choose H and K
        public bool SomaOn = true;                        // set soma to be clamp to vstart
        ...
        public void printMatrix(double[,] rhsMarray, double[,] lhsMarray, string strPath, DateTime now)
        {
            var rhsMatrix = new StreamWriter(strPath + @"\rhsMatrix_" + now.Hour + "_" + now.Minute + "_" + now.Second + ".txt", true);
            var lhsMatrix = new StreamWriter(strPath + @"\lhsMatrix_" + now.Hour + "_" + now.Minute + "_" + now.Second + ".txt", true);
